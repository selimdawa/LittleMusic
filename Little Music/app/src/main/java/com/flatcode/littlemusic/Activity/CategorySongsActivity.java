...
public class CategorySongsActivity extends AppCompatActivity {
    ...
    private ActivityCategorySongsBinding binding;
    Activity activity = CategorySongsActivity.this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityCategorySongsBinding.inflate(getLayoutInflater());
